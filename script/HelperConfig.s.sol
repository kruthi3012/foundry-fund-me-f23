...
// 1.Deploy mocks (contracts) when we are on a local anvil chain
...
contract HelperConfig is Script {
    ...
    //otherwise grab existing addresses from running network
    NetworkConfig public activeNetworkConfig;

    uint8 public constant DECIMALS = 8;
    int256 public constant INITIAL_PRICE = 2000e8;
    uint32 public constant SEPOLIA_CHAIN_ID = 11155111;
    uint32 public constant ETH_CHAIN_ID = 1;
    ...
    function getOrCreateAnvilEthConfig() public returns (NetworkConfig memory) {
        //price feed address
        // deploy mock and return that address
